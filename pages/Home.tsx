  ...
  return (
    <div className="bg-white">
      ...
      <motion.a 
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 left-8 w-16 h-16 bg-green-500 text-white rounded-full flex items-center justify-center shadow-2xl z-[110] cursor-pointer border-4 border-white transition-transform"
